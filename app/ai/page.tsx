...
const tools: Tool[] = [
  ...
  {
    title: "SOAP Note (รันในเครื่อง)",
    description:
      "แปลงบทสนทนาแพทย์กับผู้ป่วยเป็นร่างเวชระเบียนภาษาไทย รูปแบบ SOAP หรือ CC/PI/PH โดยประมวลผลทั้งหมดในเครื่องผู้ใช้ ไม่ส่งข้อมูลออกสู่อินเทอร์เน็ต ใช้โมเดลที่ฝึกเฉพาะงานเวชระเบียนไทยด้วยข้อมูลสังเคราะห์ 540 เคส (ไม่มีข้อมูลผู้ป่วยจริง)",
    status: "live",
    url: "/ai/soap",
    public: true,
