...
const lessonsX = [
  ...
  },
  {
    ...
    th: "/learn/space",
    en: "/learn/space/en",
    level: "บทพิเศษ · ดาราศาสตร์",
    title: "ระบบสุริยะและจักรวาล ฉบับเจาะลึก",
    enTitle: "The Solar System and the Universe, in Depth",
    text:
      "ดวงอาทิตย์ส่องแสงได้อย่างไร ทำไมดาวเคราะห์ไม่ตกใส่ดวงอาทิตย์ ดวงจันทร์เปลี่ยนรูปเพราะอะไร ดาวเกิดและตายอย่างไร และเรารู้ได้อย่างไรว่าจักรวาลอายุ 13,800 ล้านปี",
    points: [
      "ภาพตัดชั้นดวงอาทิตย์ ดาวเคราะห์ 8 ดวง และย่อระบบสุริยะให้เท่าสนามโรงเรียน",
      "ปืนใหญ่ของนิวตันยิงให้เข้าวงโคจรได้จริง ตรวจกฎของเคปเลอร์ และน้ำหนักบนดาวดวงอื่น",
      "ข้างขึ้นข้างแรมตามปฏิทินไทย สีของดาวบอกอุณหภูมิ และเส้นทางชีวิตดาว 3 แบบ",
      "ปีแสงเทียบเวลาเดินทาง ลูกโป่งจักรวาลขยาย ไทม์ไลน์บิ๊กแบง ภาพประกอบ 17 ภาพ และแบบทดสอบ 12 ข้อ",
    ],
  },
  {
    key: "ai",
    th: "/learn/ai",
    en: "/learn/ai/en",
    level: "บทพิเศษ · เทคโนโลยี",
    title: "ปัญญาประดิษฐ์ AI เรียนรู้อย่างไร",
    enTitle: "Artificial Intelligence: How Machines Learn",
    text:
      "AI เรียนจากตัวอย่างอย่างไร ทำไมนักวิทยาศาสตร์ลอกแบบมาจากเซลล์ประสาทในสมอง แชตบอตคิดคำตอบอย่างไร ทำไมมันผิดได้อย่างมั่นใจ และเราควรใช้มันอย่างไรให้ฉลาดและปลอดภัย",
    points: [
      "สอนเครื่องแยกแมวกับหมาด้วยมือตัวเอง แล้วลองใส่ป้ายผิดดูว่าเกิดอะไรขึ้น",
      "ตั้งน้ำหนักเซลล์ประสาทเทียมเอง แล้วกดให้เครื่องฝึกจนทายถูกครบ",
      "เครื่องทายคำถัดไปตัวจิ๋ว วาดภาพเป็นตัวเลข จับผิดภาพ AI และกฎความปลอดภัย",
      "อัปเกรดคำสั่งให้ AI ด้วย 5 ส่วนประกอบ และ 8 ไอเดียใช้ AI ให้ฉลาดขึ้นพร้อมตัวอย่างคำสั่ง",
      "เบื้องหลัง AI ขั้นสูงที่ใช้สร้าง Body 101 ทีละขั้น และสิ่งที่หมอตรวจในแต่ละขั้น",
      "คำศัพท์ AI 32 คำ แบ่ง 3 ระดับจากเริ่มต้นถึงกึ่งขั้นสูง พร้อมโหมดทดสอบตัวเอง ภาพประกอบ 21 ภาพ และแบบทดสอบ 12 ข้อ",
    ],
  },
  {
    key: "robot",
    th: "/learn/robot",
    en: "/learn/robot/en",
    level: "บทพิเศษ · ลงมือสร้าง",
    title: "AI ขั้นสูงและหุ่นยนต์ จากศูนย์ถึงสร้างเอง",
    enTitle: "Advanced AI and Robots: From Zero to Building Your Own",
    text:
      "บทยาว 11 ระดับที่เริ่มจากศูนย์จริงๆ ไฟฟ้าหนึ่งวงจร สมองกล เซ็นเซอร์ มอเตอร์ การควบคุม หุ่นยนต์ที่เรียนรู้เอง AI ขั้นสูงในหุ่นยนต์รุ่นใหม่ ไปจนถึงหุ่นยนต์ที่ช่วยร่างกายคนไข้ แล้วปิดท้ายด้วยโครงงานที่ทำตามได้จริง",
    points: [
      "ต่อวงจรหลอดแอลอีดีเอง เขียนโปรแกรมพาหุ่นยนต์เดินถึงดาว และดูห้องผ่านสายตาของลิดาร์",
      "ปรับความเร็วล้อให้เลี้ยว จูนแรงแก้ทิศของรถเดินตามเส้น และฝึกหุ่นยนต์ให้หาทางเองด้วยรางวัล",
      "ดูว่า AI สนใจคำไหนในประโยค และสั่งมือเทียมด้วยแรงกล้ามเนื้อให้จับไข่โดยไม่แตก",
      "3 โครงงานพร้อมรายการอุปกรณ์ ตารางต่อสาย และโค้ด Arduino คำศัพท์ 24 คำ ภาพประกอบ 17 ภาพ และแบบทดสอบ 12 ข้อ",
    ],
  },
  {
    key: "airobot",
    th: "/learn/airobot",
    en: "/learn/airobot/en",
    level: "บทพิเศษ · สมองกับร่างกาย",
    title: "AI กับหุ่นยนต์ ทีมเดียวกัน",
    enTitle: "AI and Robots, One Team",
    text:
      "AI เป็นสมอง หุ่นยนต์เป็นร่างกาย พอต่อกันจะกลายเป็นวงที่วนไม่หยุด รับรู้ คิด ส่งคำสั่ง ขยับ ดูผล บทนี้ใช้ระบบประสาทของเราเป็นแผนที่ช่วยเข้าใจ แล้วปิดท้ายด้วยการต่อ AI ที่สอนเองให้ขับรถจริง",
    points: [
      "ภารกิจหุ่นยนต์ผู้ช่วยหยิบแอปเปิล เห็นทุกขั้นส่งงานต่อกัน และเป็นคนที่หุ่นยนต์ถามเมื่อมันไม่แน่ใจ",
      "เทียบชั้นควบคุมของหุ่นยนต์กับไขสันหลัง สมองน้อย และสมองส่วนหน้า ในมุมของหมอสมอง",
      "ความมั่นใจกับเส้นเกณฑ์ รีเฟล็กซ์กับความหน่วง การเลียนแบบ รางวัล และชั้นความปลอดภัย",
      "โครงงาน AI ขับรถ จากการ์ดลูกศรหน้ากล้องไปจนถึงล้อหมุน พร้อมเกม คำศัพท์ และแบบทดสอบ",
    ],
  },
];
      ...
      <section className="lp-hero" aria-labelledby="lp-title">
        ...
        <div className="container lp-hero-inner">
          <div className="lp-hero-copy">
            ...
            <p className="lp-lead">
              บทเรียนแบบกดเล่นได้ 17 บท สองระดับและบทพิเศษ ส่องกล้องจุลทรรศน์ เปิดร่างกายทีละชั้น ทดลองการระบาดของไวรัส
      ...
      <section className="section" aria-labelledby="lx-title">
        <div className="container">
          <div className="section-head">
            <h2 id="lx-title">บทพิเศษ</h2>
            <p>บทที่ใช้ภาพประกอบเป็นสื่อการสอน พาไปรู้จักอาชีพหมอสมอง ออกไปสำรวจระบบสุริยะจนถึงขอบจักรวาล เปิดดูว่า AI เรียนรู้อย่างไร ลงมือสร้างหุ่นยนต์ตัวแรกของเราเอง และต่อสมอง AI เข้ากับร่างกายหุ่นยนต์</p>
          </div>
          <div className="cards two lp-grid">
            {lessonsX.map((l, i) => (
              <LessonCard l={l} n={13 + i} key={l.key} />
            ))}
          </div>
        </div>
      </section>
        ...
        <div className="container">
          <div className="lp-arena">
            ...
            <div className="lp-arena-copy">
              ...
              <p>
                รวมคำถาม 344 ข้อจากทุกบทไว้ที่เดียว มี 5 โหมด แข่งกับเวลา 60 วินาที ปะทะสองคนบนจอเดียว
