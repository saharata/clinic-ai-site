      ...
      <section className="hero small">
        <div className="container">
          ...
          <p className="hero-text">
            บทเรียนแบบกดเล่นได้ 4 บท ต่อกันเป็นเส้นทางเดียว เริ่มจากเซลล์เล็กจิ๋วที่ต้องส่องกล้องถึงจะเห็น
            แล้วค่อยๆ ซูมออกจนถึงร่างกายทั้งตัว เทียบกับพืชและสัตว์ และจบที่การดูแลร่างกายให้โตอย่างแข็งแรง มีทั้งภาษาไทยและภาษาอังกฤษ เล่นได้บนมือถือ แท็บเล็ต และคอมพิวเตอร์
          </p>
        </div>
      </section>
