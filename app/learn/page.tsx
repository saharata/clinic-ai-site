      ...
      <section className="lp-hero" aria-labelledby="lp-title">
        ...
        <div className="container lp-hero-inner">
          <div className="lp-hero-copy">
            ...
            <p className="lp-lead">
              บทเรียนแบบกดเล่นได้ 14 บท สองระดับและบทพิเศษ ส่องกล้องจุลทรรศน์ เปิดร่างกายทีละชั้น ทดลองการระบาดของไวรัส
      ...
      <section className="section" aria-labelledby="lx-title">
        <div className="container">
          <div className="section-head">
            ...
            <p>บทที่ใช้ภาพประกอบเป็นสื่อการสอน พาไปรู้จักอาชีพหมอสมอง และออกไปสำรวจระบบสุริยะจนถึงขอบจักรวาล</p>
          </div>
          <div className="cards two lp-grid">
            {lessonsX.map((l, i) => (
        ...
        <div className="container">
          <div className="lp-arena">
            ...
            <div className="lp-arena-copy">
              ...
              <p>
                รวมคำถาม 252 ข้อจากทุกบทไว้ที่เดียว มี 5 โหมด แข่งกับเวลา 60 วินาที ปะทะสองคนบนจอเดียว
