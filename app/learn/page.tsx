      ...
      <section className="hero small">
        <div className="container">
          ...
          <p className="hero-text">
            บทเรียนแบบกดเล่นได้ 11 บท แบ่งเป็นสองระดับ ระดับหนึ่งสำหรับ ป.3 ถึง ป.6 เริ่มจากเซลล์เล็กจิ๋ว
      ...
      <section className="section">
        <div className="container cta-box">
          <div>
            ...
            <p>
              รวมคำถาม 188 ข้อจากทุกบทไว้ที่เดียว มี 5 โหมด แข่งกับเวลา 60 วินาที ปะทะสองคนบนจอเดียว
